...
function [ lifetime_list, density, lumen_list] =  polytrack ( tracks_input_RAW, Label, dt )
...
%%  ===================================================
% Collect density 
[ density.monomers, density.tracks, density.weighted_polymers ] = get_particle_density( state, Nframes );
figure(2)
